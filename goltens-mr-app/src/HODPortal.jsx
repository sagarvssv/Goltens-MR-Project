      ...
      <div style={s.shell}>
        ...
        <div style={s.main}>
          <div style={s.topBar}>
            ...
            <NotificationBell mrs={mrs} role="hod" userEmail={session.email} accentColor={"#4a148c"} onNavigate={mr=>{ setSelected(mr); setView("queue"); setTimeout(()=>window.scrollTo(0,0),100); }}/>
          </div>
